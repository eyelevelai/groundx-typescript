...
export class Groups {
    ...
    public async list(
    ...
    ): Promise<GroundX.GroupListResponse> {
        ...
        if (_response.ok) {
            return _response.body as GroundX.GroupListResponse;
        }
    ...
    public async create(
        ...
        if (_response.ok) {
            return _response.body as GroundX.GroupResponse;
        }
     ...
     */
    public async get(groupId: number, requestOptions?: Groups.RequestOptions): Promise<GroundX.GroupResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.GroundXEnvironment.Default,
     ...
     */
    public async delete(groupId: number, requestOptions?: Groups.RequestOptions): Promise<GroundX.MessageResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.GroundXEnvironment.Default,
                `v1/group/${encodeURIComponent(groupId)}`
        ...
        if (_response.ok) {
            return _response.body as GroundX.MessageResponse;
        }
     ...
     */
    public async addBucket(
        groupId: number,
        bucketId: number,
        requestOptions?: Groups.RequestOptions
    ): Promise<GroundX.MessageResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.GroundXEnvironment.Default,
